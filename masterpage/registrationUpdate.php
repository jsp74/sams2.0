            ...
            <div class="collapse navbar-collapse" id="myNavbar">
                <ul class="nav navbar-nav">
                    ...
                    <li class="dropdown">
                        ...
                        <ul class="dropdown-menu">
                            <li><a id = "archery2" href="#">Archery</a></li>
                            <li><a id = "fencing2" href="#">Fencing</a></li>
                            <li><a id = "field2" href="#">Field</a></li>
                            <li><a id = "swimming2" href="#">Swimming</a></li>
                            <li><a id = "tabletennis2" href="#">Table Tennis</a></li>
                            <li><a id = "teamsport2s" href="#">Team Sports</a></li>
                            <li><a id = "track2" href="#">Track</a></li>
                            <li><a id = "other2" href="#">Other Sports</a></li>
                        </ul>
                    </li>
